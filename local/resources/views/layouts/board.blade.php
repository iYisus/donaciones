            ...
            <ul class="nav navbar-nav ">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('admin')}}" class="">
                         <span class="fa fa-anchor solo">Admin</span></a>
                         </li>
                        <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('citas')}}" data-scroll="" class="">
                            <span class="fa fa-anchor solo">Citas</span>
                            </a>
                         </li>
                         <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('eventos')}}" data-scroll="" class="">
                            <span class="fa fa-anchor solo">Eventos</span>
                            </a>
                         </li>
                         <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('medicos')}}" data-scroll="" class="">
                            <span class="fa fa-anchor solo">Medicos</span>
                            </a>
                         </li>
                         <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('especialidades')}}" data-scroll="" class="">
                            <span class="fa fa-anchor solo">Especialidades</span>
                            </a>
                         </li>
                           <li class="hidden-sm hidden-md hidden-lg"> <a href="{{URL('usuarios')}}" data-scroll="" class="">
                              <span class="fa fa-anchor solo">Usuarios</span>
                              </a>
                           </li>
